...
MANUAL_OVERRIDES = {
    "en": {
        "공유": "Share", "문의": "Contact", "소개": "About", "일상": "Daily life",
        "전체": "All", "회원": "Member", "순발력": "Reflexes", "완료!": "Complete!",
        "지금!": "Now!", "집중력": "Focus", "테스트": "Test", "플레이": "Plays",
        "한국어": "Korean", "게임하기": "Play", "내 기록": "My records",
        "로그아웃": "Sign out", "반응속도": "Reaction speed", "시작 →": "Start →",
        "이용약관": "Terms of Use", "읽을거리": "Guides", "확인하기": "Check",
        "A. 소뇌": "A. Cerebellum", "B. 해마": "B. Hippocampus", "C. 연수": "C. Medulla oblongata",
        "게임 목록": "Game list", "게임 시작": "Start game", "공유 완료": "Shared",
        "공유 취소": "Sharing canceled", "광고 안내": "Advertising", "기록 공유": "Share score",
        "기록 도전": "Challenge the record", "누적 도전": "Total attempts", "다시 도전": "Try again",
        "다시 준비": "Get ready again", "반응속도 테스트": "Reaction Speed Test",
        "숫자 순서 게임": "Number Order Game", "아직 기록 없음": "No record yet",
        "지금 플레이 →": "Play now →", "좋은 기록이에요": "Great score",
        "기억력 게임": "Memory Game", "게임 목록 보기": "View game list",
        "개인정보처리방침": "Privacy Policy", "광고·제휴 문의": "Advertising & Partnerships",
        "너무 빨랐어요!": "Too soon!", "다음 숫자: 1": "Next number: 1",
        "내용·주소 복사됨": "Text and link copied", "모든 단계 성공!": "All levels complete!",
        "순서를 기억하세요": "Remember the sequence", "정답! 다음 단계": "Correct! Next level",
        "오늘의 추천 공유": "Share today’s pick", "무료 · 설치 없음": "Free · No installation",
        "반응속도 측정 영역": "Reaction speed area", "아직 누르지 마세요": "Don’t tap yet",
        "이제 몸이 풀렸어요": "You’re warmed up", "초록색을 기다리세요": "Wait for green",
        "같은 순서로 누르세요": "Tap in the same order", "게임을 시작해 보세요": "Start the game",
        "로그아웃하고 있어요…": "Signing out…", "개인정보 관련 요청은": "For privacy requests,",
    },
